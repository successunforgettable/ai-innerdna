...
const stateDescriptionsPart2 = {
  ...
  "6": {
    veryGood: {
      name: "Very Good State",
      description: "I feel calm, grounded, and deeply supported both within myself and by life itself. I trust my instincts and blend logic with wisdom. I respond to uncertainty with steadiness, not fear. I'm loyal, principled, and able to lead others with quiet strength. When challenges arise, I face them with courage and resilience. I trust my inner voice and no longer second-guess everything. I feel safe not because the world is perfect, but because I know I can handle it."
    },
    good: {
      name: "Good State",
      description: "I'm dependable, thoughtful, and always thinking ahead. I like to be prepared and plan for any situation. I value loyalty, honesty, and strong relationships both personal and professional. I may worry sometimes, but I use that to keep things organized and running smoothly. I'm a steady, protective presence for those I care about. People rely on me because I'm consistent and trustworthy. I like knowing the rules and sticking to them, especially when they keep everyone safe."
    },
    average: {
      name: "Average State",
      description: "I often feel a low-level anxiety that doesn't go away. I overthink situations and doubt my decisions. I want to feel safe and certain, but I rarely do. I look to others for reassurance, but then second-guess their advice. I try to control what I can and stay alert for potential problems. I can be skeptical and question people's intentions, even when they've done nothing wrong. I'm torn between trusting my gut and fearing I'll make a mistake."
    },
    belowAverage: {
      name: "Below Average State",
      description: "I become increasingly reactive and suspicious. I assume the worst and act from fear. I struggle to trust anyone even those who care about me. I obsess over worst-case scenarios and worry myself into paralysis. I push people away, then feel alone and unsupported. I follow rules rigidly or rebel completely, depending on who I think I can trust. I struggle with authority needing it, resenting it, fearing it. I feel like the world is out to get me."
    },
    destructive: {
      name: "Destructive State",
      description: "I feel like I'm under attack mentally, emotionally, spiritually. My thoughts spiral out of control, and I'm consumed by fear. I see betrayal everywhere and trust no one, not even myself. I lash out or shut down. I may turn to rigid ideologies, conspiracy theories, or compulsive behaviours just to feel a sense of control. I become emotionally erratic, paranoid, panicked, or frozen. I'm trapped in a prison of my own mind, and everything feels unsafe, uncertain, and terrifying."
    }
  }
};
