...
const FOUNDATION_TEST_CASES: TestCase[] = [
  ...
  },
  {
    ...
    selections: [0, 0, 1, 1, 1, 1, 1, 1, 1], // Head + Security + Assertive + Connection + Emotional + Recognition + Support + Relational + Reciprocity
    expectedType: "7"
  },
...
const SUBTYPE_TEST_CASES = [
  ...
  { distribution: { self: 5, oneToOne: 3, social: 2 }, expectedPrimary: "self", expectedStack: "moderate" },
  { distribution: { self: 2, oneToOne: 5, social: 3 }, expectedPrimary: "oneToOne", expectedStack: "moderate" },
  { distribution: { self: 3, oneToOne: 2, social: 5 }, expectedPrimary: "social", expectedStack: "moderate" },
